<div class="container mx-auto px-4 py-5">
    <div class="header-text">
        <h1 class="uppercase tracking-wide text-3xl text-indigo-600 font-bold">@lang('building.update_exist_building_title')
        </h1>
        <hr>
        <p class="mt-2 text-gray-600">@lang('building.update_exist_building_description')</p>
    </div>

    <form class="mt-6" wire:submit.prevent="updateBuildingModel">
        <!-- Update Massage  -->
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full px-3 mb-6 md:mb-0">
                @if (session()->has('message'))
                <script>
                    alertify.notify("@lang('building.update_exist_building_after_submit_updated_title')", 'success', 3);
...
">
            ...
            <div class="relative overflow-hidden px-3 mt-8">
                <button class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded" type="submit">
                    @lang('building.update_exist_building_label_update_exist_btn')
                </button>
            </div>

            <div class="relative overflow-hidden px-3 mt-8">
                <a href="{{route('building.show' , $building->id)}}" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded" type="submit">
                    @lang('building.index_table_header_see')
                </a>
