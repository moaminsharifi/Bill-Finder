        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input wire:model="name"
                    ...
                    id="add_new_category_label_category_name" type="text" placeholder="Doe">
            ...
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-state">
                    @lang('category.add_new_category_label_category_city')
                </label>
                <div class="relative">
                    <select wire:model="city"
                        ...
                        <option value="" selected disabled hidden>
                            @lang('category.add_new_category_label_category_city_select_one')</option>
                        <option value="tehran">@lang('category.tehran')</option>
                        <option value="qeshem">@lang('category.qeshem')</option>
                        <option value="bandar">@lang('category.bandar')</option>
                    </select>
            ...
            <div class="w-full mt-6 px-3">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                    for="add_new_category_label_category_address">
                    @lang('category.add_new_category_label_category_address')
                </label>

                <textarea
                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                    wire:model="address" id="add_new_category_label_category_address" cols="30" rows="10"
            ...
            <div class="w-full mt-6 px-3">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                    for="add_new_category_label_category_google_map_url">
                    @lang('category.add_new_category_label_category_google_map_url')
                </label>
                <input wire:model="google_map_url"
                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                    id="add_new_category_label_category_google_map_url" type="text" placeholder="https://www.google.com/maps/d/viewer?msa=0&mid=1J9mfceV7K1k0itaTytt-7iX8PT4&ll=35.69611100000001%2C51.423056000000024&z=17
">
